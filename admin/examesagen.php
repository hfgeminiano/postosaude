...
<div class="row">
    <div class="container mt-5">
        ...
        <div class="col-md-16">
            <h3 class="text-center text-info">Exames Agendados</h3>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                $sql = "SELECT exame.id,exame.dia,exame.tipo,usuario.nome,laboratorio.nome FROM exame INNER JOIN usuario ON exame.usuario_id = usuario.id INNER JOIN laboratorio ON exame.laboratorio_id = laboratorio.id WHERE exame.posto_id = $id_posto AND exame.estado = 'agendado'";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="atenderexame.php" enctype="multipart/form-data">
