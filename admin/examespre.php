    ...
    <div class="container mt-5">
        ...
        <div class="col-md-16">
            ...
            <table class="table">
                ...
                $sql = "SELECT exame.id,exame.dia,exame.tipo,usuario.nome,laboratorio.nome FROM exame INNER JOIN usuario ON exame.usuario_id = usuario.id INNER JOIN laboratorio ON exame.laboratorio_id = laboratorio.id WHERE exame.posto_id = $id_posto AND exame.estado = 'pre agendado'";
