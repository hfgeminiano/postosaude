                        ...
                        <div class="card-body">
                            <div class="row justify-content-md-justify">
                                <div class="col-sm-4">
                                    ...
                                    $sql = "SELECT consulta.id as id_consulta,consulta.dia,consulta.estado,usuario.nome,posto.nome FROM consulta INNER JOIN usuario ON consulta.usuario_id = usuario.id INNER JOIN posto ON consulta.posto_id = posto.id WHERE usuario.id = $id_paciente AND consulta.tipo_paciente = 0 AND consulta.estado = 'pre agendado'";
                                            ...
                                            <div class="col mb-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="cancela_consulta.php?id=<?php echo $item['id_consulta']; ?>" class="btn btn-Danger">Cancelar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    require("conexao.php");
                                    $id_paciente = $_SESSION['id'];
                                    $sql = "SELECT consulta.id as id_consulta,consulta.dia,consulta.estado,usuario.nome FROM consulta INNER JOIN usuario ON consulta.usuario_id = usuario.id WHERE usuario.id = $id_paciente AND consulta.tipo_paciente = 0 AND consulta.estado = 'agendado'";
                                    $executa = mysqli_query($conn, $sql);
                                    while ($item = mysqli_fetch_array($executa)) {
                                    ?>
                                        <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    require("conexao.php");
                                    $id_paciente = $_SESSION['id'];
                                    $sql = "SELECT consulta.id as id_consulta,consulta.dia,consulta.id,consulta.horario,consulta.estado,usuario.nome FROM consulta INNER JOIN usuario ON consulta.usuario_id = usuario.id WHERE usuario.id = $id_paciente AND consulta.estado = 'atendido' AND consulta.tipo_paciente = 0";
                        ...
                        <div class="card-body">
                            <div class="row justify-content-md-justify">
                                <div class="col-sm-4">
                                    ...
                                    require("conexao.php");
                                    $id_paciente = $_SESSION['id'];
                                    $sql = "SELECT exame.id as id_exame,exame.dia,exame.tipo,exame.estado,usuario.nome,posto.nome,laboratorio.nome FROM exame INNER JOIN usuario ON exame.usuario_id = usuario.id INNER JOIN posto ON exame.posto_id = posto.id INNER JOIN laboratorio on exame.laboratorio_id = laboratorio.id WHERE usuario.id = $id_paciente AND exame.estado = 'pre agendado'";
                                    $executa = mysqli_query($conn, $sql);
                                    while ($item = mysqli_fetch_array($executa)) {
                                    ?>
                                        <div class="row">
                                            <div class="col mb-5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="cancela_exame.php?id=<?php echo $item['id_exame']; ?>" class="btn btn-Danger">Cancelar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    require("conexao.php");
                                    $id_paciente = $_SESSION['id'];
                                    $sql = "SELECT exame.id as id_exame,exame.dia,exame.tipo,exame.estado,usuario.nome,posto.nome,laboratorio.nome FROM exame INNER JOIN usuario ON exame.usuario_id = usuario.id INNER JOIN posto ON exame.posto_id = posto.id INNER JOIN laboratorio on exame.laboratorio_id = laboratorio.id WHERE usuario.id = $id_paciente AND exame.estado = 'agendado'";
                                    $executa = mysqli_query($conn, $sql);
                                    while ($item = mysqli_fetch_array($executa)) {
                                    ?>
                                        <div class="row">
